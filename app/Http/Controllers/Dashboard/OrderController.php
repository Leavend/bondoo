...
class OrderController extends Controller
{
        ...
        return DB::transaction(function () use ($request) {
            ...
            foreach ($contents as $content) {
                OrderDetails::create([
                    ...
                    'unit_type' => $content->options->unit_type ?? 'primary',
    ...
    public function updateStatus(Request $request)
    {
        ...
        DB::transaction(function () use ($order_id) {
            ...
            // Idempotent: never decrement stock twice if the order is already complete
            if ($order->order_status === 'complete') {
                return;
            }

            $details = OrderDetails::with('product')->where('order_id', $order_id)->get();
            ...
            foreach ($details as $detail) {
                ...
                $product->decrement('stock', $detail->quantity * $multiplier);
            }
