...
<head>
    <title>bondoo Invoice #{{ $order->invoice_no }}</title>
                        ...
                        <div class="invoice-info">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    <h4 class="inv-title-1">bondoo</h4>
                                    <p class="inv-from-1">admin@bondoo.id</p>
                                    <p class="inv-from-2">Bontang, East Kalimantan, Indonesia</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    ...
                                    <p class="inv-from-1">Total Pay: Rp. {{ number_format($order->pay_amount, 0, ',', '.') }}</p>
                                    <p class="inv-from-1">Due: Rp. {{ number_format($order->due_amount, 0, ',', '.') }}</p>
                                </div>
                            </div>
                        </div>
<!-- Order Summary -->
