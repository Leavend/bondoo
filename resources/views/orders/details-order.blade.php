                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control bg-white" value="{{ number_format($order->pay_amount, 0, ',', '.') }}" readonly>
                                        </div>
                                        </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control bg-white" value="{{ number_format($order->due_amount, 0, ',', '.') }}" readonly>
                                        </div>
                                        </div>
                                        </div>
                                        </div>
                            ...
                            <table class="table mb-0">
                                ...
                                <tfoot class="bg-light">
                                    <tr>
                                        ...
                                        <td class="font-weight-bold">Rp. {{ number_format($order->sub_total, 0, ',', '.') }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" class="text-right font-weight-bold">VAT</td>
                                        <td class="font-weight-bold">Rp. {{ number_format($order->vat, 0, ',', '.') }}</td>
                                    </tr>
                                    <tr>
