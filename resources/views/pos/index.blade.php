                        ...
                        <div class="p-3 border-bottom bg-light">
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-outline-primary" title="Add New Customer" data-toggle="modal"
...
@section('specificpagescripts')
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            ...
            // Restore customer from localStorage on page load
            const savedId = localStorage.getItem('selected_customer_id');
            const savedText = localStorage.getItem('selected_customer_text');
            if (savedId && savedText) {
                var newOption = new Option(savedText, savedId, true, true);
            ...
            customerSelect.on('select2:select', function (e) {
                ...
                localStorage.setItem('selected_customer_id', data.id);
                localStorage.setItem('selected_customer_text', data.text);
            });

            customerSelect.on('select2:unselect select2:clear', function () {
                localStorage.removeItem('selected_customer_id');
                localStorage.removeItem('selected_customer_text');
            });
        });
        ...
        async function updateCart(rowId, qty, unitType = null) {
            const customerId = getCustomerId();
            try {
        ...
        function calculateChange() {
            ...
            const totalAmount = parseFloat(totalElement.dataset.total || totalElement.innerText.replace(/,/g, ''));
            ...
            if (!isNaN(payInput) && payInput >= 0) {
                ...
                changeElement.innerText = Math.round(change).toLocaleString('id-ID');
        ...
        function validateAndShowModal() {
            ...
            document.getElementById('modal_pay_amount').innerText = Math.round(payAmount).toLocaleString('id-ID');

            const change = payAmount - totalAmount;
            document.getElementById('modal_change_amount').innerText = Math.round(change).toLocaleString('id-ID');
        ...
        async function submitOrder(event) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (document.getElementById('change_amount')) document.getElementById('change_amount').innerText = '0';
