...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .receipt-container {
            width: 58mm; /* Standard 58mm Thermal Width */
            margin: 10px auto;
            background: #fff;
            padding: 2mm;
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="header text-center mb-3">
            <h2 class="font-bold text-uppercase" style="letter-spacing: -0.02em;">bondoo</h2>
            <p>Bontang, East Kalimantan</p>
            <p>Tel: +62 548 123456</p>
        </div>
        ...
        <div class="text-center mb-3 mt-3">
            <p class="font-bold mb-1" style="font-size: 9px; letter-spacing: -0.02em;">SCAN TO PAY VIA QRIS</p>
            <img src="{{ asset('assets/images/qris_static.png') }}" style="width: 100%; max-width: 110px; height: auto;" alt="QRIS QR Code">
        </div>
